...
KE.setting = {
	...
	newlineTag : 'br',
	cssPath : '',
	skinsPath : HOST +'static/css/',
	pluginsPath : HOST +'plugins/',
	minWidth : 200,
	minHeight : 100,
	minChangeSize : 5,
	items : [
		'bold', 'italic', 'underline', /*'strikethrough',*/ 'justifyleft', 'justifycenter', 'justifyright', 'justifyfull', 'insertorderedlist', 'insertunorderedlist', 'indent', 'outdent', /*'subscript', 'superscript', 'hr', 'link', 'unlink',*/ /*,'fullscreen', '-'*/ 'fontsize', /*'emoticons',*/ 'undo', 'redo', 'cut', 'copy', 'paste', /*'plainpaste', 'wordpaste'*/ 'textcolor', 'bgcolor', 'image', /*'flash', 'media'*/ 'table', 'source'/*, 'selectall'*/
		/*'removeformat', 'about', 'print', 'title', 'fontname',*/
	],
	colorTable : [
...
KE.util = {
	...
	getFullHtml : function(id) {
		...
		html += '<link href="' + KE.g[id].skinsPath + 'css/editor.css?ver=' + KE.version + '" rel="stylesheet" type="text/css" />';
		if (KE.g[id].cssPath) {
	...
	getMediaImage : function(id, type, url, width, height, autostart) {
		...
		var html = '<img class="' + className + '" src="' + KE.g[id].skinsPath + 'i/spacer.gif" ';
...
KE.plugin['about'] = {
	click : function(id) {
		...
		var dialog = new KE.dialog({
			id : id,
			cmd : 'about',
			file : 'about.php?id=' + id + '&ver=' + KE.version,
			width : 300,
			height : 70,
			loadingMode : true,
			title : KE.lang['about'],
...
KE.plugin['plainpaste'] = {
	click : function(id) {
		...
		this.dialog = new KE.dialog({
			id : id,
			cmd : 'plainpaste',
			file : 'plainpaste.php?id=' + id + '&ver=' + KE.version,
			width : 400,
			height : 300,
			loadingMode : true,
...
KE.plugin['wordpaste'] = {
	click : function(id) {
		...
		this.dialog = new KE.dialog({
			id : id,
			cmd : 'wordpaste',
			file : 'wordpaste.php?id=' + id + '&ver=' + KE.version,
			width : 400,
			height : 300,
			loadingMode : true,
...
KE.plugin['emoticons'] = {
	...
	exec : function(id, value) {
		var html = '<img src="' + KE.g[id].pluginsPath + 'emoticons/' + value + '" width="24" height="24" border="0" alt="" style="vertical-align:middle" />';
		KE.util.insertHtml(id, html);
		this.menu.hide();
		KE.util.focus(id);
	}
...
KE.plugin['flash'] = {
	...
	click : function(id) {
		...
		this.dialog = new KE.dialog({
			id : id,
			cmd : 'flash',
			file : 'flash.php?id=' + id + '&ver=' + KE.version,
			width : 400,
			height : 140,
			loadingMode : true,
			title : KE.lang['flash'],
...
KE.plugin['image'] = {
	...
	click : function(id) {
		...
		this.dialog = new KE.dialog({
			id : id,
			cmd : 'image',
			file : 'image/image.php?id=' + id + '&ver=' + KE.version,
			width : 400,
			height : 230,
			loadingMode : true,
			title : KE.lang['image'],
...
KE.plugin['link'] = {
	...
	click : function(id) {
		...
		this.dialog = new KE.dialog({
			id : id,
			cmd : 'link',
			file : 'link/link.php?id=' + id + '&ver=' + KE.version,
			width : 400,
			height : 100,
			loadingMode : true,
			title : KE.lang['link'],
...
KE.plugin['media'] = {
	...
	click : function(id) {
		...
		this.dialog = new KE.dialog({
			id : id,
			cmd : 'media',
			file : 'media.php?id=' + id + '&ver=' + KE.version,
			width : 400,
			height : 170,
			loadingMode : true,
			title : KE.lang['media'],
